...
@section('addBreadcrumbs')
    <li class="active">
        <a href="{{-- {{ route('gestionCancion.index') }} --}}"><i class="voyager-wallet" aria-hidden="true"></i> Gestion de Canciones</a>
    </li>
    <li class="active">
        <a href="{{-- {{ route('gestionCancion.invitar') }} --}}"><i class="voyager-plus" aria-hidden="true"></i></i> Crear Canción</a>
    </li>
@endsection
