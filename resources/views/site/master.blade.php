                ...
                <div class="row row-40">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div class="group-md group-middle social-items"><a
                                ...
                                href="https://web.facebook.com/PRISMADMUSIC" target="_blank"></a><a
                                class="icon icon-md novi-icon mdi mdi-twitter" href="#" target="_blank"></a><a
                                class="icon icon-md novi-icon mdi mdi-instagram"
                                href="https://www.instagram.com/prismadmusic/" target="_blank"></a><a
                                class="icon icon-md novi-icon mdi mdi-facebook-messenger"
                                href="https://web.facebook.com/messages/t/231338047199947" target="_blank"></a><a
                        ...
                        <ul class="instafeed instagram-gallery" data-lightgallery="group">
                            ...
                            <li><a class="instagram-item" data-lightgallery="item"
                                    href="images/insta-gallery-2-1200x800-original.jpg"><img
                                        src="{{ asset('onwave/images/insta-gallery-2-72x72.jpg') }}" alt=""
                                        width="72" height="72" /></a>
                            </li>
                            <li><a class="instagram-item" data-lightgallery="item"
                                    href="images/insta-gallery-3-1200x800-original.jpg"><img
                                        src="{{ asset('onwave/images/insta-gallery-3-72x72.jpg') }}" alt=""
                                        width="72" height="72" /></a>
                            </li>
                            <li><a class="instagram-item" data-lightgallery="item"
                                    href="images/insta-gallery-4-1200x800-original.jpg"><img
                                        src="{{ asset('onwave/images/insta-gallery-4-72x72.jpg') }}" alt=""
                                        width="72" height="72" /></a>
                            </li>
                            <li><a class="instagram-item" data-lightgallery="item"
                                    href="images/insta-gallery-5-1200x800-original.jpg"><img
                                        src="{{ asset('onwave/images/insta-gallery-5-72x72.jpg') }}" alt=""
                                        width="72" height="72" /></a>
                            </li>
                            <li><a class="instagram-item" data-lightgallery="item"
                                    href="images/insta-gallery-6-1200x800-original.jpg"><img
                                        src="{{ asset('onwave/images/insta-gallery-6-72x72.jpg') }}" alt=""
                                        width="72" height="72" /></a>
                            </li>
                        </ul>
                    </div> --}}
